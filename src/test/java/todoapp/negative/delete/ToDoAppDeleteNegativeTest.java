package todoapp.negative.delete;
...
public class ToDoAppDeleteNegativeTest {
    ...
    @ParameterizedTest
    @MethodSource("todoapp.negative.ToDoAppTestData#checkDeleteToDoTaskWithNonExistentIdTestData")
    public void checkDeleteToDoTaskWithNonExistentId(BigInteger nonExistentId, String username, String password) {
    ...
    @ParameterizedTest
    @MethodSource("todoapp.negative.ToDoAppTestData#checkDeleteToDoTaskWithInvalidUsernameTestData")
    public void checkDeleteToDoTaskWithInvalidUsername(String taskJson, BigInteger id, String incorrectUsername,
                                                       String password) {
    ...
    @ParameterizedTest
    @MethodSource("todoapp.negative.ToDoAppTestData#checkDeleteToDoTaskWithInvalidPasswordTestData")
    public void checkDeleteToDoTaskWithInvalidPassword(String taskJson, BigInteger id, String username,
